...
export const TodoList = ({
  ...
  return (
    <div className="space-y-4 ">
      ...
      <div className="border rounded-lg overflow-hidden dark:border-gray-700 max-h-[calc(100vh-312px)] min-h-[calc(100vh-312px)] bg-white dark:bg-neutral-800 p-4 flex flex-col gap-2 overflow-y-auto">
        {todos.length === 0 ? (
